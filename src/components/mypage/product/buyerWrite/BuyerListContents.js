...
import ProductItem from 'components/mypage/product/buyerWrite/ProductItem'
import SerachPopup from 'components/mypage/product/bindWrite/SerachPopup'
import Button from 'components/atomic/Button'
import Badge from 'components/atomic/Badge'

const BuyerListContents = (props) => {
  ...
  const handleMainCheckbox = useCallback(
    (index) => {
      let _form = form.map((product) => {
        return { ...product, mainYn: 'N' }
      })
...
export default BuyerListContents
